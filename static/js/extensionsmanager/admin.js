...
pimcore.registerNS("pimcore.plugin.extensionsmanager.admin");
pimcore.plugin.extensionsmanager.admin = Class.create({
    ...
    activate: function () 
    {
        var tabPanel = Ext.getCmp("plugin_extensionmanager_admin");
        tabPanel.activate("plugin_extensionmanager_admin");
    },
    ...
    getTabPanel: function () {
        ...
        if (!this.panel) {
            this.panel = new Ext.Panel({
                id: "plugin_extensionmanager_admin",
            ...
            this.panel.on("destroy", function () {
                pimcore.globalmanager.remove("plugin_extensionmanager_admin");
            }.bind(this));
            ...
            tbar: [{
                ...
                handler: function () {
                    try {
                        ...
                        pimcore.globalmanager.add("plugin_extensionmanager_search", new pimcore.plugin.extensionsmanager.search());
                    }
                }.bind(this)
